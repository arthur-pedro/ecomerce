        ...
        <div class="container-fluid">
            ...
            <nav class="collapse navbar-collapse" id="primary-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="carrinho.html"><span class="glyphicon glyphicon-shopping-cart"> R$0.00 (0 itens)</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                ...
                <div id="menu1" class="tab-pane fade in active">
                    <!-- row -->
                    <div class="row">
                        <form method="post" action="php/add_carrinho.php">
                           
                            <?php
                                
                                require("php/select_servicos.php");

                                // Select na base pra montar a area de servios
                                $cont = 1;
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-4 banner-text">
                                        <div class="box">
                                            ...
                                            <div id="item_1">
                                                ...
                                                <p>'. $row[3] .'</p>
                                                <hr>
                                                <input type="submit" name="btn_buy_'.$cont.'" class="btn button" onclick="get_item();" data-toggle="modal" data-target="#buy" value="Escolher">    
                                            </div>
