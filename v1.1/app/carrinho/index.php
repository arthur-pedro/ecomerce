...
<div class="mainmenu-area" data-spy="affix" data-offset-top="100">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="../main/index.php" class="navbar-brand logo" style="">
                <h2>creative lab</h2>
            </a>
        </div>
        <!--Logo/-->
        <nav class="collapse navbar-collapse" id="primary-menu">
            <ul class="nav navbar-nav navbar-right">
                <li ><a href="../main/index.php">Voltar às compras</a></li>
                    ...
                    foreach ($_SESSION['shoppingCart'] as $key => $item) {
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box-icon">
                                ...
                                <h3 class=""><?php print_r($obj->getName()); ?></h3>
                                <h5>R$ <?php print_r($obj->getPrice()); ?></h5>
                                <p><?php print_r($obj->getDescription()); ?></p>
                                <button onclick="remove_item_carrinho('<?php print_r($obj->getName()); ?>');" id="btn-remover" name="btn_remove_item" class="btn button" data-toggle="modal" data-target="#remove">Remover</button>
                            </div>
                        </div>
...
<div class="container">
    <div class="row text-center">
        ...
        <div class="col-sm-3"><button onclick="clearShoppingCar('<?php echo $_SESSION["qtd_produtos"] ?>');" type="button" id="btn-enviar-pedido" class="btn button">Limpar carrinho</button></div>
        </ul>
        <div class="col-sm-3"></div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-md" ">
        <div class="modal-content">
            ...
            <div id="notificacao" class="modal-body">
                ...
                <h2 style="text-align: center;"> Valor do projeto: </h2><h1 style="text-align: center;">R$ 0.00</h1>
...
<script src="asset/js/ajax_request_removeItem.js"></script>
